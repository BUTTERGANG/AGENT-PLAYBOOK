...
# CLAUDE.md — AGENT-PLAYBOOK Agent Startup

> **Scope:** This SCRUM board covers AGENT-PLAYBOOK only. This repo is the master framework template for all new BUTTERGANG app development.
